...
with the \code{tinytest} function. \marginpar{\code{setup}}
<<eval=FALSE>>=
tinytest("/path/to/your/package")
@
...
Alternatively, you can use\marginpar{\code{build\_install\_test}}
<<eval=FALSE>>=
...
that your working directory is the testing directory (by default \code{tinytest}).
